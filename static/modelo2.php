...
class DatosBD {
    ...
    function agregaComando($comando, $estado) {
       ...
       # echo "$comando";
        $sql = "update P1.comando set comando='$comando', estado=$estado where idcomando =1;";
        $conexion->query($sql);
    ...
    function consultaComando(){        
        ...
        $conexion = $this->conectarBD();
        $sql = "SELECT comando,estado FROM P1.comando where idcomando=1;";
    ...
    function eliminaComando(){
         $conexion = $this->conectarBD();
       # echo "$comando";
        $sql = "update P1.comando set comando=NULL, estado=NULL where idcomando =1;";
        $conexion->query($sql);
        $this->desconectarBD($conexion);
        return 1;
